...
public class TableGenerator {
    ...
    public String generateTable(final List<String> headersList, final double[][] rowsList,
                                final int... overRiddenHeaderHeight){
        return null;
    }

    public String generateTable(final List<String> headersList, final List<List<String>> rowsList,
                                final int... overRiddenHeaderHeight) {
